...
public class ChatRoomDummy {
    ...
    public void makeChatRoom() {
        ChatRoom oneToOneRoom1 = new ChatRoom(null, "1:1 채팅방 1");
        ChatRoom oneToOneRoom2 = new ChatRoom(null, "1:1 채팅방 2");
        ChatRoom oneToOneRoom3 = new ChatRoom(null, "1:1 채팅방 3");

        ChatRoom groupRoom1 = new ChatRoom(null, "그룹 채팅방 1");
        ChatRoom groupRoom2 = new ChatRoom(null, "그룹 채팅방 1");
        ChatRoom groupRoom3 = new ChatRoom(null, "그룹 채팅방 1");
